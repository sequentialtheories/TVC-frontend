          ...
          maxHeight: 'calc(90vh - 120px)'
            ...
            <div>
              ...
              <div className="text-xs text-gray-500">
                {clubCreationData.isChargedContract ? "Enables 1-12 month contracts with $1.25/user/week fee for timeline flexibility" : "Traditional contracts (1+ years) with standard $1/user/week utility fee"}
              </div>
            </div>
