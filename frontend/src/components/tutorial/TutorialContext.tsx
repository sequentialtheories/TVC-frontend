...
export const TUTORIAL_STEPS: TutorialStep[] = [
  // ========== BUBBLE 1/6: Welcome & Wallet ==========
  {
    ...
    target: 'nav-wallet',
    title: 'Welcome',
    message: 'Start by opening the Wallet tab to set up your account.',
    position: 'top',
  ...
  },
  {
    ...
    message: 'Tap here to create your account. This will generate a secure wallet linked to your email.',
    position: 'top',
    advanceOn: 'action',
  ...
  // ========== BUBBLE 2/6: Future Page ==========
  {
    ...
    message: 'Open the Future tab to see how your deposits could grow over time.',
    position: 'top',
    advanceOn: 'navigation',
  ...
  },
  {
    ...
    message: 'This page shows three investment "Strands," each with different earnings rates. Adjust the parameters to explore potential outcomes.',
    position: 'bottom',
    advanceOn: 'dismiss',
  ...
  // ========== BUBBLE 3/6: Data Page ==========
  {
    ...
    target: 'nav-data',
    title: 'Transparency',
    message: 'The Data page provides detailed information on fund distributions and live rates. Optional, but available for those who want full visibility.',
    position: 'top',
    advanceOn: 'navigation',
  ...
  // ========== BUBBLE 4/6: Contracts Page ==========
  {
    ...
    title: 'Contracts',
    message: 'Open the Contracts tab to view available options.',
    position: 'top',
    advanceOn: 'navigation',
    advanceValue: 'group',
  ...
  },
  {
    ...
    message: 'Here you can create a new contract or join an existing one. Both options are available depending on your preference.',
    position: 'bottom',
    advanceOn: 'dismiss',
    requiredPage: 'group',
  ...
  // ========== BUBBLE 5/6: Homepage & Sequence Theory ==========
  {
    ...
    target: 'nav-home',
    title: 'Return Home',
    message: 'Navigate back to the Homepage.',
    position: 'top',
    advanceOn: 'navigation',
    advanceValue: 'home',
    requiredPage: 'group',
  ...
  },
  {
    ...
    message: 'The Sequence Theory link provides access to company details, team information, and additional resources.',
    position: 'bottom',
    advanceOn: 'dismiss',
    requiredPage: 'home',
  ...
  // ========== BUBBLE 6/6: Contract Details on Homepage ==========
  {
    ...
    title: 'Your Overview',
    message: 'The Homepage displays your contract summary, including total value and deposit distribution across Strands. Setup complete.',
    position: 'top',
    advanceOn: 'dismiss',
    requiredPage: 'home',
